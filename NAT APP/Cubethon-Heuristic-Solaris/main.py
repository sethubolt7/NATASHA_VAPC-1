            ...
            try:
                ...
                # mouse controlds
                    ...
                    while True:
                        ...
                        # break"""
                            ...
                            if 'number' in ans:
                                try:
                                    ...
                                    if no <= a:
                                        ...
                                        speak("but if you command me to play music of,..., my wish .   i can do that ")
                        ...
                        elif "activate mouse" in query or "activate most" in query or "activate mouth" in query:
                            dead = False
                        ...
                        elif ("terminate mouse" in query or "terminate most" in query) and dead != True:
                            dead = True
                            ...
                            speak("don't  worry  the emergency message  is  sent  to   the  emergency number  given in the  NAT  app")
